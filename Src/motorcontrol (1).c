...
void initVariables(){
	...
	MotorParam_1.kiw		= 7.5e-6F;
	MotorParam_1.kpw		= 1.6e-2F;
...
void reinitVariables(){
	...
	initPIclamp	(&wPI, 		MotorParam->kpw, 	MotorParam->kiw, 	1.F, 	MotorParam->iMax,  	-1.F, 	0.F);
	initPI			(&idPI, 	MotorParam->kpd, 	MotorParam->kid, 	1.F, 	60.F, 							-50.F, 	0.F);
	initPI			(&iqPI, 	MotorParam->kpd, 	MotorParam->kid,	1.F, 	60.F, 							-50.F, 	0.F);	
